...
unset($__errorArgs, $__bag); ?> select2" aria-label="Roles" id="roles" name="roles[]">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <?php if($role!='Super Admin'): ?>
                                                <option value="<?php echo e($role); ?>" <?php echo e(in_array($role, old('roles') ?? []) ? 'selected' : ''); ?>>
                                                <?php echo e($role); ?>
...
<?php echo $__env->make('layouts.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\Documents\tracker\resources\views/users/create.blade.php ENDPATH**/ ?>